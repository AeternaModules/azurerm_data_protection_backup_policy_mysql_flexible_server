resource "azurerm_data_protection_backup_policy_mysql_flexible_server" "data_protection_backup_policy_mysql_flexible_servers" {
  for_each = var.data_protection_backup_policy_mysql_flexible_servers
  ...
  default_retention_rule {
    dynamic "life_cycle" {
      for_each = each.value.default_retention_rule.life_cycle
      content {
